...
namespace AwtterSDK.Editor.Tools
{
    public class CameraToolsMenu : EditorWindow
    {
        ...
        public static List<CameraRes> Resolutions { get; } = new()
        {
            new("16K Full", 16384, 8640, "", "16384:8640"),
            new("16K", 15360, 8640, "", "16:9"),
            new("12K", 12288, 6480, "", "16:9"),
            new("UW10K", 10240, 4320, "", "21:9"),
            new("8K UHD", 7680, 4320, "4320p", "16:9"),
            new("4K UHD", 3840, 2160, "2160p", "16:9"),
            new("UWQHD", 3440, 1440, "", "21:9"),
            new("WQHD", 2560, 1440, "", "16:9"),
            new("Full HD", 1920, 1080, "1080p", "16:9"),
            new("", 1440, 1080, "1080i", "16:9"),
            new("", 1280, 1080, "1080i", "16:9"),
            new("HD", 1280, 720, "720p", "16:9"),
            new("VGA", 640, 480, "", "4:3"),
            new("Custom", -1, -1, "", "")
        };
        ...
        {
            var window = (CameraToolsMenu)GetWindow(typeof(CameraToolsMenu), false, "Camera tool");
        ...
        public void OnGUI()
        {
            ...
            if (GUILayout.Button("Refresh", GUILayout.Height(16))) RefreshCameras();
            ...
            for (var x = 0; x < Resolutions.Count; x++)
            {
                ...
                {
                    if (GUILayout.Button(
                            Resolutions[x].Resolution.x != -1
                                ? $"{Resolutions[x].Resolution.x}x{Resolutions[x].Resolution.y}"
                                : "", ButtonCustom2, GUILayout.Width(80)))
                    {
                        SelectedResolutionIndex = x;
                        PictureResolutionWidth = (int)Resolutions[x].Resolution.x;
                        PictureResolutionHeight = (int)Resolutions[x].Resolution.y;
            ...
            if (GUILayout.Button("Open")) OutputPath = EditorUtility.OpenFolderPanel("Output path", OutputPath, "Pics");
            GUILayout.EndHorizontal();
            GUI.enabled = false;
        ...
        {
            var tex = new Texture2D(rt.width, rt.height, Transparent ? TextureFormat.ARGB32 : TextureFormat.RGB24,
                false, true);
            ...
            var path = Path.Combine(OutputPath, $"{type}_{DateTime.Now.ToString("yyyy-dd-M-HH-mm-ss")}.png");
